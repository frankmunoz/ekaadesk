!function () {
    ...
    angular.module("app", [
        ...
        function () {
            "use strict";
            angular.module("app.walkers", [])
        }(),
        function () {
            "use strict";
            angular.module("app.inkind", [])
        }(),
        function () {
            "use strict";
                ...
                $rootScope.$on("$routeChangeStart", function (event, next, current) {
                    ...
                    authService.get('persons/' + ls.user_id).then(function (results) {
                        if (results.user.id) {
                            ...
                            $rootScope.name = results.user.first_name + " " + results.user.last_name;
                            $rootScope.email = results.user.email;
                            $rootScope.partner = results.partner;
                            $rootScope.rol = results.user.rol;
                        } else {
        ...
        function () {
            ...
            function authService($http, log) {
                //var serviceBase = 'http://192.168.0.4:8000/api/v1/';
...
//                            log.logError("Oh snap! Change a few things up and try submitting again.")
                obj.get = function (q) {
                    return $http.get(localStorage.getItem('path') + q).then(function (results) {
                        return results.data;
                    });
                };
                obj.post = function (q, object) {
                    return $http.post(localStorage.getItem('path') + q, object).then(function (results) {
                        return results.data;
                    });
                };
                obj.put = function (q, object) {
                    return $http.put(localStorage.getItem('path') + q, object).then(function (results) {
                        return results.data;
                    });
                };
                obj.delete = function (q) {
                    return $http.delete(localStorage.getItem('path') + q).then(function (results) {
                        return results.data;
                    });
                };
        ...
        function () {
            ...
            function a() {
                var a = [{
                        ...
                        path= {
                            js: 'http://localhost:8080/ekaaweb/frontend/app/',
                            css: 'http://localhost:8080/ekaaweb/frontend/app/shared/',
                            //service: 'http://192.168.0.4:8000/api/v1/'
                            service: JSON.parse(localStorage.getItem('data')),
        //  'http://200.91.218.166:8000/api/v1/'
        //                    js: 'http://pruebas.desarrollo.com/app/',
        //                    css: 'http://pruebas.desarrollo.com/app/blocks/',
        //                    service: 'http://pruebas.desarrollo.com/api/'
                        },
                        icon= {
                            edit: 'glyphicon-edit',
                            delete: 'glyphicon-remove-sign',
                            contract: 'glyphicon glyphicon-folder-open'
                        },
        ...
        function () {
            ...
            function a(a, b, c, d, e, $location, authService) {
                ...
                a.signOut = function(){
                    authService.post('logout').then(function (results) {
        ...
        function () {
            ...
            angular.module("app").config(["$routeProvider", function (a) {
                    ...
                    b = [
                            ...
                            ,"app/calendar"
                            ,"kitchens"
                            ,"kitchens/kitchens-edit"
                            ,"school"
                            ,"school/school-edit"
                            ,"walkers"
                            ,"walkers/walkers-edit"
                            ,"inkind"
                            ,"inkind/inkind-edit"
                            ,"selectLocation"
                        ]; 
                  ...
                  /*  }).when("/dashboard", {
                        ...
                        templateUrl: "app/kitchens/kitchens-list.html",
                        controller: 'kitchensCtrl',
                        controllerAs: 'kitchens'

                    }).when('/kitchen/:id', {
                        templateUrl: "app/kitchens/kitchens-edit.html",
                        controller: 'kitchensCtrl',
                        controllerAs: 'kitchens'
                    }).when('/kitchen/', {
                        templateUrl: "app/kitchens/kitchens-edit.html",
                        ...
                        templateUrl: "app/school/school-list.html",
                        ...
                        templateUrl: "app/inkind/inkind-list.html",
                        controller: 'inkindCtrl',
                        controllerAs: 'inkind'

                    }).when('/inkind/:id', {
                        templateUrl: "app/inkind/inkind-edit.html",
                        controller: 'inkindCtrl',
                        controllerAs: 'inkind'
                    }).when('/inkind/', {
                        templateUrl: "app/inkind/inkind-edit.html",
                        ...
                        templateUrl: "app/walkers/walkers-list.html",
                        controller: 'walkersCtrl',
                        controllerAs: 'walkers'

                    }).when('/walker/:id', {
                        templateUrl: "app/walkers/walkers-edit.html",
                        controller: 'walkersCtrl',
                        controllerAs: 'walkers'
                    }).when('/walker/', {
                        templateUrl: "app/walkers/walkers-edit.html",
                        ...
                        templateUrl: "app/location/select-location.html",
                ...
                }]).run(["$rootScope", "$location", "authService","$translate", function ($rootScope, $location, authService,$translate) {
                    $rootScope.$on("$routeChangeStart", function (event, next, current) {
                        $rootScope.authenticated = false;
                        var ls;
                        try{
...
/*                        case "中文":
        ...
        function () {
            ...
            angular.module("app.page").factory("collectionService", ['$http', 'logger', collectionService])
        }(),
        function () {
            "use strict";
            ...
            function authCtrl($scope, $rootScope, $routeParams, $location, $http, authService,collectionService,appConfig) {
                $scope.login = {};
                $scope.signup = {};
...
//                    appConfig.path.service = "http://192.168.0.9:8000/api/v1/";
                ...
                $scope.onCentralServer = function(){
                    appConfig.path.service = "http://200.91.218.166:8000/api/v1/";
                    localStorage.setItem("path",appConfig.path.service);
                }

                $scope.doLogin = function (customer) {
                    authService.post('login', customer).then(function (results) {
                        authService.toast(results);
                        ...
                        collectionService.get('genders').then(function(results){
                            localStorage.setItem('genders',JSON.stringify(results))
                        });
                    }).then(function(data){
                        collectionService.get('disabilities').then(function(results){
                            localStorage.setItem('disabilities',JSON.stringify(results) );
                        });
                    }).then(function(data){
                        collectionService.get('documentstype').then(function(results){
                            localStorage.setItem('documentstype',JSON.stringify(results) );
                        });
                    }).then(function(data){
                        collectionService.get('householdroles').then(function(results){
                            localStorage.setItem('householdroles',JSON.stringify(results) );
                        });
                    }).then(function(data){
                        collectionService.get('maritalstatus').then(function(results){
                            localStorage.setItem('maritalstatus',JSON.stringify(results) );
                        });
                    }).then(function(data){
                        collectionService.get('migratorystatus').then(function(results){
                            localStorage.setItem('migratorystatus',JSON.stringify(results) );
                        });
                    }).then(function(data){
                        collectionService.get('nationalities').then(function(results){
                            localStorage.setItem('nationalities',JSON.stringify(results) );
                        });
                    }).then(function(data){
                        collectionService.get('geolocations').then(function(results){
                            localStorage.setItem('geolocations',JSON.stringify(results) );
                        });
                    }).then(function(data){
                        collectionService.get('geolocationstype').then(function(results){
                            localStorage.setItem('geolocationstype',JSON.stringify(results) );
                        });
                    }).then(function(data){
                        collectionService.get('institutions').then(function(results){
                            localStorage.setItem('institutions',JSON.stringify(results) );
                        });
                    }).then(function(data){
                        collectionService.get('roles').then(function(results){
                            localStorage.setItem('roles',JSON.stringify(results) );
                        });
                    }).then(function(data){
                        collectionService.get('modalitiestype').then(function(results){
                            localStorage.setItem('modalitiestype',JSON.stringify(results) );
                        });
                    }).then(function(data){
                        collectionService.get('modalities/').then(function(results){
                            localStorage.setItem('modalities',JSON.stringify(results) );
                        });
                    }).then(function(data){
                        collectionService.get('recipients').then(function(results){
                            localStorage.setItem('recipients',JSON.stringify(results) );
                        });
                    }).then(function(data){
                        var session = JSON.parse(localStorage.getItem('data'));
                        collectionService.get('institutions/partner/' + session.partner + '/geolocation/').then(function(results){
                            localStorage.setItem('institutionsByPartner',JSON.stringify(results) );
                        });
                    }).then(function(data){
                        var session = JSON.parse(localStorage.getItem('data'));
                        collectionService.get('partner/'+session.partner+'/geolocationstype/1/geolocations/').then(function(results){
                            localStorage.setItem('geolocationsByPartner',JSON.stringify(results) );
                        });
                    }).then(function(data){
/*                        
...
*/
/*
                            console.log("INSIDE000",navigator);

                        if (navigator.geolocation) {
                            console.log("INSIDE0");
                            navigator.geolocation.getCurrentPosition(function(position){
                                console.log("INSIDE1",position);
                                var coords = {
                                    "latitude":position.coords.latitude,
                                    "longitude":position.coords.longitude
                                };
                                console.log("INSIDE2",coords);
                                localStorage.setItem('position',JSON.stringify(coords) );
                            });
                        }
                        */
                        ...
                        authService.toastError("Error " + data.data.Error);
                    });
                };

                $scope.signup = {email: '', password1: '', password2: '', username: '', partner: '', rol: ''};
                $scope.doSignUp = function (customer) {
                    authService.post('registration', 
                        customer).then(function (results) {
                        authService.toast(results);
                        localStorage.setItem('data',JSON.stringify(results) )
                        if (results.key =! null) {
                            $location.path('welcome');
            ...
            angular.module("app.page").controller("invoiceCtrl", ["$scope", "$window", a]).controller("authCtrl", ["$scope", "$rootScope", "$routeParams", "$location", "$http", "authService","collectionService","appConfig", authCtrl])
