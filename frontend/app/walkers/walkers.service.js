...
(function () {
    ...
    angular
            .module('app.walkers')
            .factory('walkersService', walkersService);

    walkersService.$inject = ['datagridService', 'appConfig', '$http'];

    /**
     * @namespace walkersService
     * @param datagridService
     * @param appConfig
     * @param $http
     * @memberOf assistance
     */
    function walkersService(datagridService, appConfig, $http) {
        ...
        function __post(walkers) {
            return $http.post(urlService + 'beneficiary/', walkers)
                    .then(getComplete)
                    .catch(getFailed);
        }
