...
(function () {
    ...
    schoolService.$inject = ['datagridService', 'appConfig', '$http'];
     ...
     * @memberOf assistance
     */
    function schoolService(datagridService, appConfig, $http) {
        ...
        function __post(school) {
            return $http.post(urlService + 'correspondencia/', school)
                    .then(getComplete)
                    .catch(getFailed);
        }
